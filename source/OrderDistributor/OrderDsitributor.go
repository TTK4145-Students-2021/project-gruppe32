...
func CostCalculator(myElev UtilitiesTypes.Elevator, otherElevators sync.ElevList, btnFloor int, btnType elevio.ButtonType) UtilitiesTypes.Elevator{
	...
	for i int = 0; i < len(otherElevators); i++{
