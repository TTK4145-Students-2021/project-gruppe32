...
For our code, we used the Golang libraries Net. and Time., and we used the delivered go-files Driver.go and Network.go. Our cost function uses the TimeToIdle() from the project resources. We have attached an overview of the interface of the different modules.
